                                    ...
                                    <div className="card mt-5">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="row mt-1">
                                                ...
                                                <div class="col-md-6 col-xl-3 col-sm-12 col-lg-6 col-xxl-3 bd_radio">
                                                    <div className="d-flex">
                                                        <input type="radio" id="testnet" name="fav_language" checked value="2" />
                                                        <div className="img_round">
                                                            <img src={bscCryptex} alt="bscCryptex" className="bsc-img1" />
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-xl-3 col-sm-12 col-lg-6 col-xxl-3 bd_radio">
                                                    <div className="d-flex">
                                                        <input type="radio" id="Polygon" name="fav_language" checked value="3" />
                                                        <div className="img_round">
                                                ...
                                                <div class="col-md-6 col-xl-3 col-sm-12 col-lg-6 col-xxl-3 bd_radio">
                                                    <div className="d-flex">
                                                        <input type="radio" id="Matic" name="fav_language" checked value="4" />
                                                        <div className="img_round">
